        ...
        internal override void RepeatingWorker()
        {
            ...
            foreach (Vessel active in vessels)
            {
                ...
                foreach (Part p in active.parts)
                {
                    ...
                    {
                        if (mc.ModuleState == ModuleCommand.ModuleControlState.Nominal && active == FlightGlobals.ActiveVessel)
...
//#endif 
        ...
        internal override void LateUpdate()
        {
            ...
            {
                vectVesselCOMScreen = FlightCamera.fetch.mainCamera.WorldToScreenPoint(FlightGlobals.ActiveVessel.localCoM);
